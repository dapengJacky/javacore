package com.gupao.reflect.writeioc;
...
public class Init {
    ...
    private static List<BeanConfig> parseXmltoBeanConfig() {
        ...
        beanConfig1.setClazz("com.gupao.reflect.ioc.A");
        beanConfig1.setId("a");
        beanConfigs.add(beanConfig1);


        BeanConfig beanConfig2 = new BeanConfig();
        beanConfig2.setClazz("com.gupao.reflect.ioc.A");
        beanConfig2.setId("b");
        beanConfig2.setFactoryMethod("createB");
        ...
        beanConfig3.setFactoryMethod("createC");
